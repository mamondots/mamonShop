            ...
            <div className=' py-12 lg:px-60 md:px-40 sm:px-20 px-10 lg:ml-20'>
                <form onSubmit={handleSubmit(onSubmit)} className='py-12 border flex items-center flex-col relative'>
                    ...
                    <div className='grid lg:grid-cols-2 lg:w-3/4 w-full lg:px-0 md:px-20 sm:px-20 px-5 py-4 lg:gap-4 text-center cursor-pointer space-y-2 lg:space-y-0'>
                         <p onClick={handleGoogle} className='flex items-center text-center py-2 lg:px-12 px-10 font-medium text-white  bg-[#E85250] hover:bg-[#e85350d4] duration-300 rounded'>Singin with google <span className='mt-1 ml-2'><FaGoogle></FaGoogle></span></p>
                         <p className='flex items-center bg-[#3A77BE] hover:bg-[#3a78bed9] duration-300 py-2  lg:px-12 px-10 font-medium text-white rounded'>Singin with facebook <span className='mt-1 ml-2'><FaFacebookF></FaFacebookF></span></p>
                    </div>
                    <p className='text-lg font-medium text-[#747474] cursor-pointer'>if you new here <Link to='/singup'>
